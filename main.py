...
"""
    ...
    if not scheduler.running:
        scheduler.add_job(post_quizzes, 'cron', day_of_week='2', hour=20, minute=30, id='wednesday_quizzes')
        scheduler.add_job(post_tech_news, 'cron', day_of_week='3', hour=20, minute=30, id='thursday_news')
        scheduler.start()
        print("✅ Scheduled tasks started at 8:30 PM IST!")
